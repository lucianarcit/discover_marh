...
Visão geral da pasta `docs` e seus 22 arquivos de documentação, organizados por área funcional do portal.

---

## Estrutura da Pasta

A pasta `docs` é plana (sem subpastas) e contém **22 arquivos Markdown** que cobrem as principais funcionalidades do portal Alelo. Os arquivos seguem uma numeração por área temática (1 a 10) mais dois arquivos suplementares sem número.

---

## Área 1 — Configuração de Benefícios

### [1CONFIG_BENE_1.md](1CONFIG_BENE_1.md)
...
### [1CONFIG_BENE_REDES.md](1CONFIG_BENE_REDES.md)
...
### [2CADASTRO_INTERLO_PERFIS.md](2CADASTRO_INTERLO_PERFIS.md)
...
### [2CADASTRO_INTERLO_EDITAR.md](2CADASTRO_INTERLO_EDITAR.md)
...
### [3CADASTRO_COLAB_TELA.md](3CADASTRO_COLAB_TELA.md)
...
### [3CADASTRO_COLAB_PLANILHA.md](3CADASTRO_COLAB_PLANILHA.md)
...
### [3CADASTRO_COLAB_TAGS.md](3CADASTRO_COLAB_TAGS.md)
...
### [4PEDIDO_TELA.md](4PEDIDO_TELA.md)
...
### [4PEDIDO_PLANILHA.md](4PEDIDO_PLANILHA.md)
...
### [5PAG_DISPO_BOLETO.md](5PAG_DISPO_BOLETO.md)
...
### [5PAG_DISPO_MODELO_COBRANCA.md](5PAG_DISPO_MODELO_COBRANCA.md)
...
### [6ACOMPA_PEDIDO_STATUS.md](6ACOMPA_PEDIDO_STATUS.md)
...
### [6ACOMPA_PEDIDO_BOLETO_NF.md](6ACOMPA_PEDIDO_BOLETO_NF.md)
...
### [6ACOMPA_PEDIDO_ALTERAR_DATA_CREDITOS.md](6ACOMPA_PEDIDO_ALTERAR_DATA_CREDITOS.md)
...
### [8RASTREIO_CARTOES.md](8RASTREIO_CARTOES.md)
...
### [9VISUALIZAR_CONTRATOS.md](9VISUALIZAR_CONTRATOS.md)
...
### [10CADASTRO_FILIAIS_TELA.md](10CADASTRO_FILIAIS_TELA.md)
...
### [10CADASTRO_POSTO_DE_TRABALHO_PLANILHA.md](10CADASTRO_POSTO_DE_TRABALHO_PLANILHA.md)
...
### [faturamento-descentralizado.md](faturamento-descentralizado.md)
...
### [manual-emissao-2via.md](manual-emissao-2via.md)
...
| Arquivo | Área | Tipo |
|---|---|---|
| [1CONFIG_BENE_1.md](1CONFIG_BENE_1.md) | Configuração de benefícios | Guia de configuração |
| [1CONFIG_BENE_REDES.md](1CONFIG_BENE_REDES.md) | Redes de aceitação | Referência |
| [2CADASTRO_INTERLO_PERFIS.md](2CADASTRO_INTERLO_PERFIS.md) | Perfis de usuário | Referência / matriz de permissões |
| [2CADASTRO_INTERLO_EDITAR.md](2CADASTRO_INTERLO_EDITAR.md) | Gerenciamento de interlocutores | Passo a passo |
| [3CADASTRO_COLAB_TELA.md](3CADASTRO_COLAB_TELA.md) | Cadastro de colaboradores (tela) | Passo a passo |
| [3CADASTRO_COLAB_PLANILHA.md](3CADASTRO_COLAB_PLANILHA.md) | Cadastro de colaboradores (planilha) | Passo a passo |
| [3CADASTRO_COLAB_TAGS.md](3CADASTRO_COLAB_TAGS.md) | Tags de produto em colaboradores | Explicação conceitual |
| [4PEDIDO_TELA.md](4PEDIDO_TELA.md) | Pedido via tela | Passo a passo |
| [4PEDIDO_PLANILHA.md](4PEDIDO_PLANILHA.md) | Pedido via planilha | Passo a passo |
| [5PAG_DISPO.md](5PAG_DISPO.md) | Pagamento e disponibilização | Passo a passo |
| [5PAG_DISPO_BOLETO.md](5PAG_DISPO_BOLETO.md) | Geração do boleto e resumo do pedido | Passo a passo |
| [5PAG_DISPO_MODELO_COBRANCA.md](5PAG_DISPO_MODELO_COBRANCA.md) | Modelo de cobrança com taxas diferidas | Explicação conceitual |
| [6ACOMPA_PEDIDO_STATUS.md](6ACOMPA_PEDIDO_STATUS.md) | Status de pedidos | Referência |
| [6ACOMPA_PEDIDO_BOLETO_NF.md](6ACOMPA_PEDIDO_BOLETO_NF.md) | Acesso ao boleto e nota fiscal | Passo a passo |
| [6ACOMPA_PEDIDO_ALTERAR_DATA_CREDITOS.md](6ACOMPA_PEDIDO_ALTERAR_DATA_CREDITOS.md) | Alterar data de disponibilização | Passo a passo |
| [7RELATORIOS.md](7RELATORIOS.md) | Módulo de relatórios | Referência / passo a passo |
| [8RASTREIO_CARTOES.md](8RASTREIO_CARTOES.md) | Rastreio de entrega de cartões | Passo a passo |
| [9VISUALIZAR_CONTRATOS.md](9VISUALIZAR_CONTRATOS.md) | Consulta de dados do contrato | Passo a passo / referência |
| [10CADASTRO_FILIAIS_TELA.md](10CADASTRO_FILIAIS_TELA.md) | Cadastro de filiais (tela) | Passo a passo |
| [10CADASTRO_POSTO_DE_TRABALHO_PLANILHA.md](10CADASTRO_POSTO_DE_TRABALHO_PLANILHA.md) | Cadastro de postos de trabalho (planilha) | Passo a passo |
| [faturamento-descentralizado.md](faturamento-descentralizado.md) | Faturamento descentralizado | Guia de funcionalidade |
| [manual-emissao-2via.md](manual-emissao-2via.md) | Emissão de segunda via de cartão | Guia de funcionalidade |
